...
public class DataCache {
	...
	public static Map<String,Map<String,Bar>> MIN30BAR = new  HashMap<String,Map<String,Bar>>();
	...
	//30分钟
	public static Map<String,LimitQueue<Bar>> minK30Tick = new HashMap<String,LimitQueue<Bar>>();
